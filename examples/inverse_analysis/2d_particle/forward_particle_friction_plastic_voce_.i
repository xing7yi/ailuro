...
[AuxKernels]
  ...
  [disp_y_scale]
    type = ParsedAux
    variable = disp_y_scaled
    coupled_variables = 'disp_y'
    expression = 'disp_y * 1e3'
...
[Functions]
  ...
  [yield_fun]
    ...
    expression = 'p0'
    param_symbol_names = 'p0 p1 p2'
    param_vector_name = 'params/parameter_results'
  []
  [hardening_fun]
    type = ParsedOptimizationFunction
    expression = 'p1'
...
[Controls]
  [yield_ctrl]
    ...
    function = yield_fun
    parameter = 'Materials/stress_specimen/yield_stress'
    execute_on = 'INITIAL TIMESTEP_BEGIN'
  []
  [hardening_ctrl]
    type = RealFunctionControl
    function = hardening_fun
    parameter = 'Materials/stress_specimen/hardening_constant'
    execute_on = 'INITIAL TIMESTEP_BEGIN'
  []
  [q_ctrl]
    type = RealFunctionControl
    function = q_fun
    parameter = 'Materials/stress_specimen/q'
    execute_on = 'INITIAL TIMESTEP_BEGIN'
  []
[]
...
[Executioner]
    ...
    [TimeStepper]
        type = ForgivingIterationAdaptiveDT
        ...
        timestep_limiting_function = measurement_time_knots
...
[Postprocessors]
    ...
    # Parameter verification postprocessors
    [yield_check]
...
[Reporters]
  ...
  [params]
    ...
    real_vector_names = 'parameter_results'
...
#     [input]
#         type = InputTimes
#         times = '2.5 5.0 7.5 10.0 11.55'
#         outputs = none
#     []    
#     # [report_times]
#     #     type = ReporterTimes
#     #     reporters = input/times
#     # []
# []