...
registerMooseObject("SolidMechanicsApp", ADIsotropicLinearHardeningStressUpdate);
registerMooseObject("SolidMechanicsApp", IsotropicLinearHardeningStressUpdate);

template <bool is_ad>
InputParameters
IsotropicLinearHardeningStressUpdateTempl<is_ad>::validParams()
{
...
template <bool is_ad>
IsotropicLinearHardeningStressUpdateTempl<is_ad>::IsotropicLinearHardeningStressUpdateTempl(
...
template <bool is_ad>
void
IsotropicLinearHardeningStressUpdateTempl<is_ad>::initQpStatefulProperties()
{
...
template <bool is_ad>
void
IsotropicLinearHardeningStressUpdateTempl<is_ad>::propagateQpStatefulProperties()
{
...
template <bool is_ad>
GenericReal<is_ad>
IsotropicLinearHardeningStressUpdateTempl<is_ad>::computeResidual(
...
template <bool is_ad>
GenericReal<is_ad>
IsotropicLinearHardeningStressUpdateTempl<is_ad>::computeDerivative(
    const GenericReal<is_ad> & /*effective_trial_stress*/, const GenericReal<is_ad> & /*scalar*/)
{
  if (_yield_condition > 0.0)
...
template <bool is_ad>
void
IsotropicLinearHardeningStressUpdateTempl<is_ad>::iterationFinalize(const GenericReal<is_ad> & scalar)
{
  if (_yield_condition > 0.0)
    _hardening_variable[_qp] = computeHardeningValue(scalar);
}
...
template <bool is_ad>
void
IsotropicLinearHardeningStressUpdateTempl<is_ad>::computeStressFinalize(
...
template <bool is_ad>
GenericReal<is_ad>
IsotropicLinearHardeningStressUpdateTempl<is_ad>::computeHardeningValue(
...
template <bool is_ad>
GenericReal<is_ad>
IsotropicLinearHardeningStressUpdateTempl<is_ad>::computeHardeningDerivative(
    const GenericReal<is_ad> & /*scalar*/)
{
//   if (_hardening_function)
//   {
...
template class IsotropicLinearHardeningStressUpdateTempl<true>;
