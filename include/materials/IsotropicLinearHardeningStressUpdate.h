...
template <bool is_ad>
class IsotropicLinearHardeningStressUpdateTempl : public RadialReturnStressUpdateTempl<is_ad>
{
public:
  static InputParameters validParams();

  IsotropicLinearHardeningStressUpdateTempl(const InputParameters & parameters);
...
typedef IsotropicLinearHardeningStressUpdateTempl<false> IsotropicLinearHardeningStressUpdate;
typedef IsotropicLinearHardeningStressUpdateTempl<true> ADIsotropicLinearHardeningStressUpdate;
